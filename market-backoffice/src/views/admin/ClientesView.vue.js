...
const { items, listLoading, listError, saveLoading, saveError, cargar, crear, actualizar, alternarEstado } = useClientes();
...
const filtered = computed(() => {
    ...
    if (!term)
        return items.value;
    return items.value.filter((c) => c.nombre.toLowerCase().includes(term) || (c.nit ?? '').toLowerCase().includes(term));
});
...
(__VLS_ctx.search);
if (__VLS_ctx.permissions.can('CLIENTES_CREAR')) {
    ...
    (__VLS_ctx.showForm ? 'Cancelar' : 'Nuevo cliente');
}
...
for (const [cliente] of __VLS_getVForSourceType((__VLS_ctx.paged))) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({
        key: (cliente.id),
    ...
    if (__VLS_ctx.permissions.can('CLIENTES_EDITAR')) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            ...{ onClick: (...[$event]) => {
                    if (!(__VLS_ctx.permissions.can('CLIENTES_EDITAR')))
                        return;
                    __VLS_ctx.abrirEditar(cliente);
                } },
            type: "button",
    ...
    if (__VLS_ctx.permissions.can('CLIENTES_EDITAR')) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            ...{ onClick: (...[$event]) => {
                    if (!(__VLS_ctx.permissions.can('CLIENTES_EDITAR')))
                        return;
                    __VLS_ctx.alternarEstado(cliente);
                } },
            type: "button",
