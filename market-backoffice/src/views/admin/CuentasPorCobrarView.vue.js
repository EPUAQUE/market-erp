...
function estadoVisual(cuenta) {
    ...
    if (cuenta.estado === 'COBRADA')
        return { variant: 'success', label: 'Cobrada' };
    return { variant: 'neutral', label: 'Anulada' };
}
const { items, listLoading, listError, pagina, tamano, totalElementos, totalPaginas, cargar, registrarCobro, anular } = useCuentasPorCobrar();
...
async function onCobrar(cuenta) {
    if (tiendaId.value === null || !montoCobro.value)
        return;
...
for (const [cuenta] of __VLS_getVForSourceType((__VLS_ctx.items))) {
    ...
    (__VLS_ctx.nombreCliente(cuenta.clienteId));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "px-4 py-2" },
    });
    ...
    (__VLS_ctx.detalleAbiertoId === cuenta.id ? 'Ocultar' : 'Ver cobros');
    if (cuenta.estado === 'PENDIENTE' && cuenta.cobros.length === 0 && __VLS_ctx.permissions.can('CUENTAS_POR_COBRAR_ANULAR')) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            ...{ onClick: (...[$event]) => {
                    if (!(cuenta.estado === 'PENDIENTE' && cuenta.cobros.length === 0 && __VLS_ctx.permissions.can('CUENTAS_POR_COBRAR_ANULAR')))
                        return;
...
if (__VLS_ctx.cuentaEnDetalle) {
    ...
    if (__VLS_ctx.cuentaEnDetalle.estado === 'PENDIENTE' && __VLS_ctx.permissions.can('CUENTAS_POR_COBRAR_COBRAR')) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.form, __VLS_intrinsicElements.form)({
            ...{ onSubmit: (...[$event]) => {
                    ...
                    if (!(__VLS_ctx.cuentaEnDetalle.estado === 'PENDIENTE' && __VLS_ctx.permissions.can('CUENTAS_POR_COBRAR_COBRAR')))
                        return;
                    __VLS_ctx.onCobrar(__VLS_ctx.cuentaEnDetalle);
                } },
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.tbody, __VLS_intrinsicElements.tbody)({});
    if (__VLS_ctx.cuentaEnDetalle.cobros.length === 0) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({});
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            colspan: "2",
            ...{ class: "px-4 py-6 text-center text-mk-text/60" },
    ...
    for (const [cobro] of __VLS_getVForSourceType((__VLS_ctx.cuentaEnDetalle.cobros))) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({
            key: (cobro.id),
            ...{ class: "border-b border-mk-border last:border-0" },
        });
