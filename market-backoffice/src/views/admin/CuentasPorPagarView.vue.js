...
function estadoVisual(cuenta) {
    if (cuenta.estado === 'PENDIENTE' && new Date(cuenta.fechaVencimiento).getTime() < Date.now()) {
        return { variant: 'overdue', label: 'Vencida' };
    }
...
async function onPagar(cuenta) {
    if (tiendaId.value === null || !montoPago.value)
        return;
    const ok = await registrarPago(tiendaId.value, cuenta, montoPago.value);
    if (ok)
        montoPago.value = '';
}
function onAnular(cuenta) {
    if (tiendaId.value !== null)
        anular(tiendaId.value, cuenta);
}
...
for (const [cuenta] of __VLS_getVForSourceType((__VLS_ctx.items))) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({
        key: (cuenta.id),
    ...
    (__VLS_ctx.nombreProveedor(cuenta.proveedorId));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "px-4 py-2" },
    });
    ...
    const __VLS_0 = __VLS_asFunctionalComponent(EstadoBadge, new EstadoBadge({
        variant: (__VLS_ctx.estadoVisual(cuenta).variant),
        label: (__VLS_ctx.estadoVisual(cuenta).label),
    }));
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...{ onClick: (...[$event]) => {
                __VLS_ctx.toggleDetalle(cuenta);
            } },
        type: "button",
        ...{ class: "mr-3 text-mk-primary hover:underline" },
    });
    (__VLS_ctx.detalleAbiertoId === cuenta.id ? 'Ocultar' : 'Ver pagos');
    if (cuenta.estado === 'PENDIENTE' && cuenta.pagos.length === 0 && __VLS_ctx.permissions.can('CUENTAS_POR_PAGAR_ANULAR')) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            ...{ onClick: (...[$event]) => {
                    if (!(cuenta.estado === 'PENDIENTE' && cuenta.pagos.length === 0 && __VLS_ctx.permissions.can('CUENTAS_POR_PAGAR_ANULAR')))
                        return;
                    __VLS_ctx.onAnular(cuenta);
                } },
            type: "button",
...
if (__VLS_ctx.cuentaEnDetalle) {
    ...
    (__VLS_ctx.cuentaEnDetalle.id);
    if (__VLS_ctx.cuentaEnDetalle.estado === 'PENDIENTE' && __VLS_ctx.permissions.can('CUENTAS_POR_PAGAR_PAGAR')) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.form, __VLS_intrinsicElements.form)({
            ...{ onSubmit: (...[$event]) => {
                    ...
                    if (!(__VLS_ctx.cuentaEnDetalle.estado === 'PENDIENTE' && __VLS_ctx.permissions.can('CUENTAS_POR_PAGAR_PAGAR')))
                        return;
                    __VLS_ctx.onPagar(__VLS_ctx.cuentaEnDetalle);
                } },
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.tbody, __VLS_intrinsicElements.tbody)({});
    if (__VLS_ctx.cuentaEnDetalle.pagos.length === 0) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({});
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            colspan: "2",
            ...{ class: "px-4 py-6 text-center text-mk-text/60" },
    ...
    for (const [pago] of __VLS_getVForSourceType((__VLS_ctx.cuentaEnDetalle.pagos))) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({
            key: (pago.id),
            ...{ class: "border-b border-mk-border last:border-0" },
        });
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            onPagar: onPagar,
            onAnular: onAnular,
            cuentaEnDetalle: cuentaEnDetalle,
        };
    },
});
