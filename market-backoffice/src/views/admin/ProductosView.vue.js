...
const { items, listLoading, listError, saveLoading, saveError, pagina, tamano, totalElementos, totalPaginas, cargar, crear, actualizar, alternarEstado, } = useProductos();
...
const filtered = computed(() => {
    ...
    if (!term)
        return items.value;
    return items.value.filter((p) => p.nombre.toLowerCase().includes(term) || p.codigoInterno.toLowerCase().includes(term));
});
...
async function onSubmit() {
    if (!form.value.categoriaId || !form.value.marcaId || !form.value.unidadMedidaId)
        return;
    const datos = {
...
(__VLS_ctx.search);
if (__VLS_ctx.permissions.can('PRODUCTOS_CREAR')) {
    ...
    (__VLS_ctx.showForm ? 'Cancelar' : 'Nuevo producto');
}
if (__VLS_ctx.showForm) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
        value: (__VLS_ctx.form.codigoInterno),
        type: "text",
        required: true,
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
        value: (__VLS_ctx.form.codigoBarras),
        type: "text",
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.select, __VLS_intrinsicElements.select)({
        value: (__VLS_ctx.form.categoriaId),
        required: true,
        ...{ class: "mk-input w-full rounded border border-mk-border bg-transparent px-3 py-2" },
    });
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.select, __VLS_intrinsicElements.select)({
        value: (__VLS_ctx.form.unidadMedidaId),
        required: true,
        ...{ class: "mk-input w-full rounded border border-mk-border bg-transparent px-3 py-2" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.option, __VLS_intrinsicElements.option)({
    ...
    for (const [u] of __VLS_getVForSourceType((__VLS_ctx.unidades))) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.option, __VLS_intrinsicElements.option)({
            key: (u.id),
            value: (u.id),
        });
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
        value: (__VLS_ctx.form.imagenUrl),
        type: "text",
        ...{ class: "mk-input w-full rounded border border-mk-border bg-transparent px-3 py-2" },
    });
...
for (const [producto] of __VLS_getVForSourceType((__VLS_ctx.filtered))) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({
        key: (producto.id),
    ...
    (__VLS_ctx.nombreCategoria(producto.categoriaId));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "px-4 py-2" },
    });
    (__VLS_ctx.nombreMarca(producto.marcaId));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "px-4 py-2" },
    });
    (__VLS_ctx.nombreUnidad(producto.unidadMedidaId));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...{ class: "px-4 py-2" },
    });
    ...
    if (__VLS_ctx.permissions.can('PRODUCTOS_VER')) {
    ...
    if (__VLS_ctx.permissions.can('PRODUCTOS_EDITAR')) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            ...{ onClick: (...[$event]) => {
                    if (!(__VLS_ctx.permissions.can('PRODUCTOS_EDITAR')))
                        return;
                    __VLS_ctx.abrirEditar(producto);
                } },
            type: "button",
            ...{ class: "mr-3 text-mk-primary hover:underline" },
        });
    ...
    if (__VLS_ctx.permissions.can('PRODUCTOS_EDITAR')) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            ...{ onClick: (...[$event]) => {
                    if (!(__VLS_ctx.permissions.can('PRODUCTOS_EDITAR')))
                        return;
                    __VLS_ctx.alternarEstado(producto);
                } },
            type: "button",
